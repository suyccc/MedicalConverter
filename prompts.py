...
concept_generation_system_prompt = f"""
    You are a biomedical expert in creating challenging and educational medical multiple-choice questions, specializing in conceptual errors.
...
reasoning_generation_system_prompt = f"""
    You are a biomedical expert in creating challenging and educational medical multiple-choice questions, specializing in reasoning errors.
...
visual_interpretation_generation_system_prompt = f"""
    You are a biomedical expert in creating challenging and educational medical multiple-choice questions, specializing in visual interpretation errors.
...
data_processing_generation_system_prompt = f"""
    You are a biomedical expert in creating challenging and educational medical multiple-choice questions, specializing in data processing errors.
...
question_bias_generation_system_prompt = f"""
    You are a biomedical expert in creating extremely challenging medical multiple-choice questions, specializing in highly sophisticated question-focused distractors.
...
fusion_generation_system_prompt = f"""
    You are a biomedical expert Selection Agent tasked with curating the most challenging and high-quality distractor options for medical multiple-choice questions based on one or more provided images.
...
naive_system_prompt = f"""
    You are a biomedical expert in creating challenging medical multiple-choice questions. Your task is to generate plausible but incorrect answer options (distractors) for a given image-based question, focusing on logical reasoning and inference errors.
...
refine_system_prompt_concept = """
    You are a biomedical expert in refining medical multiple-choice questions, specializing in creating high-quality, challenging distractors based on conceptual errors. Your task is to refine concept-based distractors from a given set, based on feedback from a reviewer.
...
refine_system_prompt_reason = """
    You are a biomedical expert in refining medical multiple-choice questions, specializing in creating high-quality, challenging distractors based on reasoning errors. Your task is to refine reasoning-based distractors from a given set, based on feedback from a reviewer.
...
refine_system_prompt_visual = """
    You are a biomedical expert in refining medical multiple-choice questions, specializing in creating high-quality, challenging distractors based on visual interpretation errors. Your task is to refine visual interpretation-based distractors from a given set, based on feedback from a reviewer.
...
refine_system_prompt_data = """
    You are a biomedical expert in refining medical multiple-choice questions, specializing in creating high-quality, challenging distractors based on data processing errors. Your task is to refine data processing-based distractors from a given set, based on feedback from a reviewer.
...
refine_system_prompt_question_bias = """
    You are a biomedical expert in refining medical multiple-choice questions, specializing in creating high-quality, challenging distractors based on question bias errors. Your task is to refine question bias-based distractors from a given set, based on feedback from a reviewer.
...
refiner_system_prompt = """
    You are a biomedical expert in educational assessment design specializing in multiple-choice question improvement. Your task is to enhance question effectiveness by revising problematic distractors (incorrect answer choices) while maintaining the existing correct answer.
